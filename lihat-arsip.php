              ...
              <body>
                ...
                <table border="0" cellpadding="4">
                  <tr>
                    ...
                    <td>
                      <h5>: <?php echo $result['nomor_surat'] ?></h5>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5>: <?php echo $result['waktu_pengarsipan'] ?></h5>
                    </td>
                  </tr>
                </table>
              </body>
              ...
              <form method="post" action="">
                <div class="card">
                  <div class="card-header">
                    ...
                    <embed src="file_pdf/<?= $result['file']; ?>" type="application/pdf" width="200%" height="500px">
                ...
                <div class="card-body">
                  ...
                  <a href="download.php?filename=<?php echo $result['file'] ?>" class="btn btn-warning" role="button">Unduh</a>
                  <a href="edit-arsip.php?nomor_surat=<?php echo $nomor_surat; ?>" class="btn btn-danger"> Edit / Ganti File </a>
                  <!-- <a href="lihat_data.php?nomor_surat='.$dt['nomor_surat'].'" class="btn btn-danger"> Edit / Ganti File </a> -->
                </div>
              </form>
        </div>
      </div>
